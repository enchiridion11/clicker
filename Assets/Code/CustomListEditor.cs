...
public class CustomListEditor : EditorWindow {
    ...
    const string AssetPath = "Assets/Code/cutomList.asset";
    ...
    void LoadData () {
        t = (CustomList) AssetDatabase.LoadAssetAtPath (AssetPath, typeof(CustomList));
    ...
    void CreateData () {
        t = CreateInstance<CustomList> ();
        AssetDatabase.CreateAsset (t, AssetPath);
        AssetDatabase.SaveAssets ();
        AssetDatabase.Refresh ();
    }

    [MenuItem ("Window/Custom List")]
    static void Initialize () {
        GetWindow (typeof(CustomListEditor)).Show ();
    }
    ...
    public void OnGUI () {
        ...
        for (int i = 0; i < ThisList.arraySize; i++) {
            ...
            SerializedProperty MyCustomClass = MyListRef.FindPropertyRelative ("ACustomClassArray");
            ...
            if (DisplayFieldType == 0) {
                ...
                EditorGUILayout.PropertyField (MyCustomClass);
               ...
               // MyCustomClass.objectReferenceValue = EditorGUILayout.ObjectField ("My Custom Class", MyCustomClass.objectReferenceValue, typeof(ItemRequirements), true);
